...
epicsEnvSet("ADDRESS", "192.168.62.86")
...
#dbLoadTemplate("$(GALIL)/GalilTestApp/Db/$(PORT)_motors-v6-9down-2.substitutions", "P=$(P), PORT=$(PORT)")
#Motor record version 6-10 and up
dbLoadTemplate("$(GALIL)/GalilTestApp/Db/$(PORT)_motors-v6-10up-2.substitutions", "P=$(P), PORT=$(PORT)")
