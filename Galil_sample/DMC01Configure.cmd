...
epicsEnvSet("ADDRESS", "192.168.21.15")
...
dbLoadTemplate("$(GALIL)/GalilTestApp/Db/$(PORT)_motors-v6-10up.substitutions", "P=$(P), PORT=$(PORT)")

#Load DMC controller features (eg.  Limit switch type, home switch type, output compare, message consoles)
dbLoadTemplate("$(GALIL)/GalilTestApp/Db/galil_dmc_ctrl.substitutions", "P=$(P), PORT=$(PORT)")

#Load extra features for real axis/motors (eg. Motor type, encoder type)
dbLoadTemplate("$(GALIL)/GalilTestApp/Db/$(PORT)_motor_extras.substitutions", "P=$(P), PORT=$(PORT)")

#Load extra features for CS axis/motors (eg. Setpoint monitor)
#dbLoadTemplate("$(GALIL)/GalilTestApp/Db/galil_csmotor_extras.substitutions", "P=$(P), PORT=$(PORT)")
...
dbLoadTemplate("$(GALIL)/GalilTestApp/Db/galil_coordinate_systems.substitutions", "P=$(P), PORT=$(PORT)")

#Load digital IO databases
dbLoadTemplate("$(GALIL)/GalilTestApp/Db/galil_dmc_digital_ports.substitutions", "P=$(P), PORT=$(PORT)")

#Load analog IO databases
dbLoadTemplate("$(GALIL)/GalilTestApp/Db/galil_dmc_analog_ports.substitutions", "P=$(P), PORT=$(PORT)")

#Load user defined functions
#dbLoadTemplate("$(TOP)/GalilTestApp/Db/galil_userdef_records.substitutions", "PORT=$(PORT)")

#Load user defined array support
dbLoadTemplate("$(GALIL)/GalilTestApp/Db/galil_user_array.substitutions", "P=$(P), PORT=$(PORT)")

#Load profiles
dbLoadTemplate("$(GALIL)/GalilTestApp/Db/$(PORT)_profileMoveController.substitutions", "P=$(P), PORT=$(PORT)")
dbLoadTemplate("$(GALIL)/GalilTestApp/Db/$(PORT)_profileMoveAxis.substitutions", "P=$(P), PORT=$(PORT)")
